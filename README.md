...
现在es6以及es7等新的js语法已经广泛应用在项目中了，询问es6的相关知识点一方面观察对es6的熟练程度，熟练程度较差的影响项目开发，也侧面反映出对新技术的学习追求较差，一般都会被否定
...
- 箭头函数、普通函数区别（非常重要），必须理解箭头函数的this本质，一点不能含糊，this的考察方式很多，只要让人感觉this掌握不清晰，基本就挂掉，除此之外，箭头函数还有其它区别和普通函数，多了解
- promise/async&await/生成器函数（非常重要），生成器函数最好了解下，要是问道啥也不知道，影响评价，promise的标准有好几套，容易弄混，建议把es6中的promise标准好好看看，这里面细节特别多，1个都不能垃，建议先系统学习下promise，然后找些promise题目，看看自己是不是有欠缺；如果可以，建议把promise的实现也了解下，属于加分项，这里的promise实现，指自己实现一个Promise类给别人用，api和es6标注保持完全一致；最后promise和es7中的async&await可以结合使用，这块建议深挖一下
...
关于类的定义、单继承、多继承一般是组合问答，其中就会牵扯到原型、原型链知识，建议对原型、原型链继承这块不是很清楚的一定要系统性学习下，把这块的原理和各种细节全部搞清楚，一点都不能含糊，否则会被认为js基础不扎实，有了这个负面评价，基本就完了
...
- 其它css知识点，css细节比较多，属于慢慢积累过程，没法短期速成全面掌握，上面几个重点搞清楚就差不多了

# 框架（特别重要）

## 考察意义

因为js非常重要，所以用js写的框架也非常重要，常见的框架有react/vue/angular，因为国内angular用得少，建议react/vue精通一门，react/vue建议精通react，对于2种框架都比较熟悉但都不是特别精通和精通其中一种，我们会选择精通其中一种的人

框架这块的问题一般先简单问下，考察是否应用熟练，不熟练基本就挂了

只是熟练应用估计也不行，因为框架是js写的，这块有很多原理性的东西可以问，也是水平分级的领域，建议把所精通的框架的实现原理好好搞清楚，不管是看文章还是看源码，结果就是原理很清楚，否则影响框架这块的评价，框架的原理如果搞清楚了，绝对是加分项
...
如果1个人js基础挺扎实，框架使用熟练，原理也特别清楚，编程不扎实会个人很奇怪的感觉，要么就是长时间做管理，编程实践少了，要不就是前面的好印象都是虚的

如果你不是大拿做管理的，建议编程这块引起重视
...
很多非计算机专业转型的前端容易栽在算法数据结构这方面，建议没有想过知识积累的，系统性学习下
...
通过项目经验可以判断你做的项目是否复杂，复杂一般代表思维、编程各方面都比较强

另外做项目容易遇到各种问题，遇到问题你是刨根问底去钻研还是绕过去也是考察重点，如果讲述项目经验过程你遇到问题忽视不管基本就挂了，如果你过去做的项目有问题当时真的忽视不管建议回过头来想想怎么去解决，把解决问题用到的方案理清楚，顺带把方案涉及到的知识点、技术原理一块研究下

# 个人学习（比较重要）

主要是个人的学习习惯，尽量养成有规律的学习习惯，给人感觉你是个有技术追求的进步青年，而不是吃老本

# 职业规划（一般重要）

这个一般只会被部门老大问到，怎么说大家估计都清楚